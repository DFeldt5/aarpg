...
@onready var attack_effect_player: AnimationPlayer = $"../../Sprite2D/AttackEffectSprite/AnimationPlayer"
...
func enter() -> void:
	...
	attack_effect_player.play("attack_" + player.animation_direction())
